...
namespace Colors
{
  ...
  extern const uint32_t DandelionYellow;
  extern const uint32_t RedPoppy;
  extern const uint32_t Marble;
  extern const uint32_t CaveWall;
  extern const uint32_t ObsidianHigh;
  extern const uint32_t ObsidianLow;
  extern const uint32_t Grass;
  extern const uint32_t GrassDot;
  extern const uint32_t Dirt;
  extern const uint32_t DirtDot;
  extern const uint32_t Player;
  extern const uint32_t Monster;
  extern const uint32_t MonsterUnique;
  extern const uint32_t ShallowWater;
  extern const uint32_t DeepWater;
  extern const uint32_t Iron;
  extern const uint32_t RoomFloor;
  extern const uint32_t Wood;
  extern const uint32_t WoodPlankSeam;
  extern const uint32_t Chest;
  extern const uint32_t Brick;
  extern const uint32_t Lava;
  extern const uint32_t LavaWaves;
  extern const uint32_t FogOfWar;
  extern const uint32_t Coins;
  extern const uint32_t DoorHighlight;
  ...
  extern const uint32_t ItemMixed;
  extern const uint32_t ItemCursed;
...
namespace Strings
{
  ...
  namespace TileNames
  {
    extern const std::string MineWall;
    extern const std::string CaveWall;
    extern const std::string ObsidianWall;
    extern const std::string Ground;
    extern const std::string Walls;
    extern const std::string Flagstone;
    extern const std::string Stone;
    extern const std::string StoneFloor;
    extern const std::string StoneWall;
    extern const std::string StoneTiles;
    extern const std::string StonePillar;
    extern const std::string StainedGlass;
    extern const std::string WoodenFloor;
    extern const std::string BrickWall;
    extern const std::string Workbench;
    extern const std::string Forge;
    extern const std::string Bed;
    extern const std::string Fountain;
    extern const std::string Dirt;
    extern const std::string Rocks;
    extern const std::string AbyssalRocks;
    ...
    extern const std::string Chasm;
    extern const std::string Gates;
    extern const std::string Stash;
    extern const std::string Window;
    extern const std::string WoodenBench;
    extern const std::string RoyalGates;
    extern const std::string Tree;
    extern const std::string WitheredTree;
    extern const std::string Grass;
    extern const std::string Blood;
    extern const std::string Hellrock;
    extern const std::string Hellstone;
    extern const std::string TiledFloor;
    extern const std::string Fachwerk;
  }
  // ---------------------------------------------------------------------------
...
namespace GlobalConstants
{
  ...
  extern const std::unordered_map<std::string, GraphicTiles> GemTileByColor;
