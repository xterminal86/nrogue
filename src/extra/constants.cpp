...
namespace Strings
{
  ...
  const std::string MsgTeleportBackInTown = "You're back in town all of a sudden!";
  const std::string MsgTeleportElsewhere  = "You are suddenly transported elsewhere!";
  // ---------------------------------------------------------------------------
  ...
  namespace TileNames
  {
    const std::string MineWall     = "Mine Wall";
    const std::string CaveWall     = "Cave Wall";
    const std::string ObsidianWall = "Obsidian Wall";
    const std::string Ground       = "Ground";
    const std::string Walls        = "Walls";
    const std::string Flagstone    = "Flagstone";
    const std::string Stone        = "Stone";
    const std::string StoneFloor   = "Stone Floor";
    const std::string StoneWall    = "Stone Wall";
    const std::string StoneTiles   = "Stone Tiles";
    const std::string StonePillar  = "Stone Pillar";
    const std::string StainedGlass = "Stained Glass";
    const std::string WoodenFloor  = "Wooden Floor";
    const std::string BrickWall    = "Brick Wall";
    const std::string Workbench    = "Workbench";
    const std::string Forge        = "Forge";
    const std::string Bed          = "Bed";
    const std::string Fountain     = "Fountain";
    const std::string Dirt         = "Dirt";
    const std::string Rocks        = "Rocks";
    const std::string AbyssalRocks = "Abyssal Rocks";
    ...
    const std::string Chasm        = "Chasm";
    const std::string Gates        = "Gates";
    const std::string Stash        = "Stash";
    const std::string Window       = "Window";
    const std::string WoodenBench  = "Wooden Bench";
    const std::string RoyalGates   = "Royal Gates";
    const std::string Tree         = "Tree";
    const std::string WitheredTree = "Withered Tree";
    const std::string Grass        = "Grass";
    const std::string Blood        = "Blood";
    const std::string Hellrock     = "Hellrock";
    const std::string Hellstone    = "Hellstone";
    const std::string TiledFloor   = "Tiled Floor";
    const std::string Fachwerk     = "Fachwerk";
  }
  // ---------------------------------------------------------------------------
  ...
  namespace Words
  {
    ...
    const std::string MAG    = "MAG";
    const std::string RES    = "RES";
    const std::string SKL    = "SKL";
...
namespace Colors
{
  ...
  //
  const uint32_t Black                = 0x000000; // "#000000";
  const uint32_t White                = 0xFFFFFF; // "#FFFFFF";
  const uint32_t Red                  = 0xFF0000; // "#FF0000";
  const uint32_t Green                = 0x00FF00; // "#00FF00";
  const uint32_t Blue                 = 0x0000FF; // "#0000FF";
  const uint32_t Cyan                 = 0x00FFFF; // "#00FFFF";
  const uint32_t Magenta              = 0xFF00FF; // "#FF00FF";
  const uint32_t Yellow               = 0xFFFF00; // "#FFFF00";
  const uint32_t DandelionYellow      = 0xF0E130; // "#F0E130";
  const uint32_t RedPoppy             = 0xE42F0C; // "#E42F0C";
  const uint32_t Marble               = 0xFFE0E0; // "#FFE0E0";
  const uint32_t CaveWall             = 0x964B00; // "#964B00";
  const uint32_t ObsidianHigh         = 0x5B4965; // "#5B4965";
  const uint32_t ObsidianLow          = 0x3D354B; // "#3D354B";
  const uint32_t Grass                = 0x006600; // "#006600";
  const uint32_t GrassDot             = 0x009900; // "#009900";
  const uint32_t Dirt                 = 0x9B7653; // "#9B7653";
  const uint32_t DirtDot              = 0x7B5633; // "#7B5633";
  const uint32_t Player               = 0x00FFFF; // "#00FFFF";
  const uint32_t Monster              = 0xFF0000; // "#FF0000";
  const uint32_t MonsterUnique        = 0xFF8888; // "#FF8888";
  const uint32_t ShallowWater         = 0x9999FF; // "#9999FF";
  const uint32_t DeepWater            = 0x3333FF; // "#3333FF";
  const uint32_t Iron                 = 0xCBCDCD; // "#CBCDCD";
  const uint32_t RoomFloor            = 0x692E11; // "#692E11";
  const uint32_t Wood                 = 0xDCB579; // "#DCB579";
  const uint32_t WoodPlankSeam        = 0x490E11; // "#490E11";
  const uint32_t Chest                = 0xA0793D; // "#A0793D";
  const uint32_t Brick                = 0xDC5539; // "#DC5539";
  const uint32_t Lava                 = 0xE36517; // "#E36517";
  const uint32_t LavaWaves            = 0xE3A917; // "#E3A917";
  const uint32_t FogOfWar             = 0x202020; // "#202020";
  const uint32_t Coins                = 0xFFD700; // "#FFD700";
  const uint32_t DoorHighlight        = 0x666600; // "#666600";
  ...
  const uint32_t ItemMixed            = 0xAA7700; // "#AA7700";
  const uint32_t ItemCursed           = 0xAA0000; // "#AA0000";
  ...
  {
      { GemType::BLACK_JETSTONE , Strings::Words::Black  }
    , { GemType::BLACK_OBSIDIAN , Strings::Words::Black  }
    , { GemType::BLUE_AQUAMARINE, Strings::Words::Blue   }
    , { GemType::BLUE_SAPPHIRE  , Strings::Words::Blue   }
    , { GemType::GREEN_EMERALD  , Strings::Words::Green  }
    , { GemType::GREEN_JADE     , Strings::Words::Green  }
    , { GemType::ORANGE_AMBER   , Strings::Words::Orange }
    , { GemType::ORANGE_JACINTH , Strings::Words::Orange }
    , { GemType::PURPLE_AMETHYST, Strings::Words::Purple }
    , { GemType::PURPLE_FLUORITE, Strings::Words::Purple }
    , { GemType::RED_GARNET     , Strings::Words::Red    }
    , { GemType::RED_RUBY       , Strings::Words::Red    }
    , { GemType::WHITE_DIAMOND  , Strings::Words::White  }
    , { GemType::WHITE_OPAL     , Strings::Words::White  }
    , { GemType::YELLOW_CITRINE , Strings::Words::Yellow }
  };
}
...
namespace GlobalConstants
{
  ...
  const std::unordered_map<std::string, GraphicTiles> GemTileByColor =
  {
      { Strings::Words::Black , GraphicTiles::GEM_BLACK  }
    , { Strings::Words::Blue  , GraphicTiles::GEM_BLUE   }
    , { Strings::Words::Green , GraphicTiles::GEM_GREEN  }
    , { Strings::Words::Orange, GraphicTiles::GEM_ORANGE }
    , { Strings::Words::Purple, GraphicTiles::GEM_PURPLE }
    , { Strings::Words::Red   , GraphicTiles::GEM_RED    }
    , { Strings::Words::White , GraphicTiles::GEM_WHITE  }
    , { Strings::Words::Yellow, GraphicTiles::GEM_YELLOW }
  };
  ...
  {
      { 0, { StatsEnum::STR, Strings::Words::STR } }
    , { 1, { StatsEnum::DEF, Strings::Words::DEF } }
    , { 2, { StatsEnum::MAG, Strings::Words::MAG } }
    , { 3, { StatsEnum::RES, Strings::Words::RES } }
    , { 4, { StatsEnum::SKL, Strings::Words::SKL } }
    , { 5, { StatsEnum::SPD, Strings::Words::SPD } }
  };

  const std::unordered_map<ItemBonusType, std::string> BonusNameByType =
  {
      { ItemBonusType::STR, Strings::Words::STR }
    , { ItemBonusType::DEF, Strings::Words::DEF }
    , { ItemBonusType::MAG, Strings::Words::MAG }
    , { ItemBonusType::RES, Strings::Words::RES }
    , { ItemBonusType::SKL, Strings::Words::SKL }
    , { ItemBonusType::SPD, Strings::Words::SPD }
    , { ItemBonusType::HP,  Strings::Words::HP  }
    , { ItemBonusType::MP,  Strings::Words::MP  }
  };
  ...
  {
      { PotionType::STR_POTION, Strings::Words::STR }
    , { PotionType::DEF_POTION, Strings::Words::DEF }
    , { PotionType::MAG_POTION, Strings::Words::MAG }
    , { PotionType::RES_POTION, Strings::Words::RES }
    , { PotionType::SKL_POTION, Strings::Words::SKL }
    , { PotionType::SPD_POTION, Strings::Words::SPD }
  };
